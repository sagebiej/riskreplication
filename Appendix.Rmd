...
author: "Author names anonymized for review process"
...
The paper, this appendix and all other material are publicly available on the open science framework (OSF) webpage. This includes the following resources:
...
- Data (prepared in order to protect respondents privacy) via GitHub

- Code for statistical analysis, creation of tables and figures, and appendix via GitHub

- Ethics approval from the German Association of Experimental Economics

(As the OSF website reveals author information it will be made available only after the review process. The code and data, however, is shared as separate files for review.)
